...
![m2](https://github.com/user-attachments/assets/f98fe7d7-ea39-46f6-af1b-59911957f148)
    ...
    <div class="product-container">
        <div class="product-card">
            <div class="product-image">
                <img src="images/product1.jpg" alt="guava fruit">
            </div>
            <div class="product-info">
                <h2 class="product-title">guava fruit</h2>
        ...
        <div class="product-card">
            <div class="product-image">
                <img src="images/product2.jpg" alt="mango">
            </div>
            <div class="product-info">
                ...
                <p class="product-description">
                    <h2>mango fruit</h2>
                    Fruits that are sweet and sour.
                </p>
                <a href="#" class="product-button">Add to Cart</a>
            </div>
        </div>
        ...
        <div class="product-card">
            ...
            <div class="product-info">
                ...
                <p class="product-description">
                    <h2>orangr fruit</h2>
                    Fruits that are citrus and high in vitamin C.
                </p>
                <a href="#" class="product-button">Add to Cart</a>
            </div>
        </div>
        ...
        <div class="product-card">
            ...
            <div class="product-info">
                <h2 class="product-title">Sapodilla</h2>
                <p class="product-price">฿60</p>
                <p class="product-description">
                    <h2>Sapodilla fruit</h2>
                    Fruits that are sweet and fragrant.
                </p>
                <a href="#" class="product-button">Add to Cart</a>
            </div>
        </div>
...
```
[บันทึกภาพหน้าจอของผลลัพธ์การทดลอง]
![m3](https://github.com/user-attachments/assets/246f62fb-4c83-45e2-bb5b-1424eaad0e7d)
...
<div class="stats-container">
<div class="stat-box">
<div class="stat-number">90,999</div>
<div class="stat-label">ผู้ใช้งาน</div>
</div>
<div class="stat-box">
<div class="stat-number">999K</div>
<div class="stat-label">ยอดขาย</div>
</div>
<div class="stat-box">
...
<style>
        ...
        .stat-box {
            ...
            background-color: rgb(64, 11, 134);
...
## การทดลองที่ 5: การจัดการข้อความและฟอนต์
![m4](https://github.com/user-attachments/assets/0a6b52dc-f2d8-4ef2-a411-524d033fc9db)
...
```
[บันทึกภาพหน้าจอของผลลัพธ์การทดลอง]
![m5](https://github.com/user-attachments/assets/9f736caa-3e1b-4d39-8f90-7301e34ea6ad)
